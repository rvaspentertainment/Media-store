...
from config import ADMINS, LOG_CHANNEL, PUBLIC_FILE_STORE, WEBSITE_URL, WEBSITE_URL_MODE, BOT_RUN 
...
@Client.on_message(filters.command(['atch', 'p1batch']) & filters.create(allowed))
